...
import com.upbeat.interactivestory.model.Page;
import com.upbeat.interactivestory.model.Story;
...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChoice1Button = (Button) findViewById(R.id.choiceButton1);
        mChoice2Button = (Button) findViewById(R.id.choiceButton2);
